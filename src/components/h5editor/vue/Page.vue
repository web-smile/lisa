...
<script>
import PicElement from "@/components/h5editor/Element/PicElement";
import FontElement from "@/components/h5editor/Element/FontElement";
import ShapesElement from "@/components/h5editor/Element/ShapesElement";
//   import 'animate.css'
