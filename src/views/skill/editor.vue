...
import Overview from "@/views/skill/overview";
import Page from "@/components/h5editor/vue/Page";
import PicPicker from "@/components/h5editor/vue/PicturePicker";
import PreView from "@/components/h5editor/vue/PreView";
import HeaderEdit from "@/components/h5editor/vue/HeaderEdit";
import EditPanel from "@/components/h5editor/vue/EditPanel";
import SvgPanel from "@/components/h5editor/vue/SvgPanel";
import ImgPanel from "@/components/h5editor/vue/ImgPanel";
import VideoPanel from "@/components/h5editor/vue/VideoPanel";
  ...
  methods: {
    dialogSave() {
      return Promise.resolve()
        .then(() => this.save())
        .then(() => this.$router.replace("themeList"));
    },
    getPicList(_id) {
